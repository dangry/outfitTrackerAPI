...
const findOutfitById = async (id: string) => {
  ...
  const outfitGarments = await OutfitsGarmentsModel.select('garment_id').where('outfit_id', id).get();
...
export { findAllGarments, findGarmentById, findOutfitById, saveGarment, saveOutfit };